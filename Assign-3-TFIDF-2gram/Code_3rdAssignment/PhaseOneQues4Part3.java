...
public class PhaseOneQues4Part3 
{
	...
	public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException 
	{
		...
		second = docPart.nextToken(); //removing special character and punctuation from the word
	...
	job.setJarByClass(PhaseOneQues4Part3.class);
