...
public class PhaseOneQues3 
{
	...
	public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException 
	{
	    ...
	    {
		second = docPart[i].replaceAll("\\p{P}", ""); //removing special character and punctuation from the word
	...
	job.setJarByClass(PhaseOneQues3.class);
